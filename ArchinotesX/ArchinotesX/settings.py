"""
Django settings for ArchinotesX project.
...
SECRET_KEY = '7k9_cu(9w=&@*ch*_u%(puq1sg49rr)o2na)5b^wv*g0yi+1^k'
...
INSTALLED_APPS = [
    'reference_architect.apps.ReferenceArchitectConfig',
...
WSGI_APPLICATION = 'ArchinotesX.wsgi.application'
