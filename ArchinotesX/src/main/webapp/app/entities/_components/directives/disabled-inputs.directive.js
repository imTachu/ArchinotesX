 ...
 * git://github.com/PLEEROCK/angular-disable-all.git
 */
(function() {
    'use strict';
    ...
    var disableAll = function(element) {
        ...
        disableElements(angular.element("input[datetime-picker] + span > button"));
    ...
    var enableAll = function(element) {
        ...
        enableElements(angular.element("input[datetime-picker] + span > button"));
