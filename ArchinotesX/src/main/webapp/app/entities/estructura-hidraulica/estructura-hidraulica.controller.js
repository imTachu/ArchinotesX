(function() {
    ...
    function EstructuraHidraulicaController ($scope, $state, EstructuraHidraulica, ParseLinks, AlertService, pagingParams, paginationConstants) {
        var vm = this;
        vm.loadAll = loadAll;
