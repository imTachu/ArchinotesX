(function() {
    ...
    function TipoVehiculoAfectadoController ($scope, $state, TipoVehiculoAfectado, ParseLinks, AlertService, pagingParams, paginationConstants) {
        var vm = this;
        vm.loadAll = loadAll;
